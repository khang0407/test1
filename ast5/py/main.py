...
def face_confidence(face_distance, face_match_threshould=0.6):
    range=(1.0-face_match_threshould)
    linear_val=(1.0-face_distance)/(range*2.0)

    if face_distance > face_match_threshould:
    ...
    def run_recognition(self):
        ...
        while True:
            ...
            if self.process_current_frame:
                ...
                self.face_encoding=face_recognition.face_locations(rgb_small_frame,self.face_location)
